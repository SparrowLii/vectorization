...
impl<'a, 'tcx, Bx: BuilderMethods<'a, 'tcx>> FunctionCx<'a, 'tcx, Bx> {
    ...
    fn codegen_vector_terminator(
        ...
        let fn_ptr = bx.tcx().mk_fn_ptr(ty::Binder::dummy(fn_sig));
        ...
        let fn_abi = FnAbi {
            args: args
                ...
                .collect(),
            ret: ArgAbi { layout: ret_ly, pad: None, mode: PassMode::Direct(ArgAttributes::new()) },
            c_variadic: false,
        ...
        bx.codegen_intrinsic_call(func, fn_ptr, &fn_abi, &args, dest, span);
